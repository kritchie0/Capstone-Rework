...
module ADC_SAR_SEQ_P4_v2_50_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("4dcb5ea5-b16f-46bb-b4ec-0a5fd667338f/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("4dcb5ea5-b16f-46bb-b4ec-0a5fd667338f/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("250144082.991803"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
...
module top ;
	...
	wire [0:0] tmpOE__V12_ADC_net;
	wire [0:0] tmpFB_0__V12_ADC_net;
	wire [0:0] tmpIO_0__V12_ADC_net;
	wire [0:0] tmpINTERRUPT_0__V12_ADC_net;
	electrical [0:0] tmpSIOVREF__V12_ADC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		V12_ADC
		 (.oe(tmpOE__V12_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V12_ADC_net[0:0]}),
		  .analog({Net_85}),
		  .io({tmpIO_0__V12_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__V12_ADC_net),
		  .interrupt({tmpINTERRUPT_0__V12_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V12_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__V5_ADC_net;
	wire [0:0] tmpFB_0__V5_ADC_net;
	wire [0:0] tmpIO_0__V5_ADC_net;
	wire [0:0] tmpINTERRUPT_0__V5_ADC_net;
	electrical [0:0] tmpSIOVREF__V5_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("423d2385-358a-424b-abed-5aaaa0266e50"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		V5_ADC
		 (.oe(tmpOE__V5_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V5_ADC_net[0:0]}),
		  .analog({Net_80}),
		  .io({tmpIO_0__V5_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__V5_ADC_net),
		  .interrupt({tmpINTERRUPT_0__V5_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V5_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EXT_TEMP_ADC_net;
	wire [0:0] tmpFB_0__EXT_TEMP_ADC_net;
	wire [0:0] tmpIO_0__EXT_TEMP_ADC_net;
	wire [0:0] tmpINTERRUPT_0__EXT_TEMP_ADC_net;
	electrical [0:0] tmpSIOVREF__EXT_TEMP_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("574ec314-8fcb-4e8d-a4c3-7697e5a77f94"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		EXT_TEMP_ADC
		 (.oe(tmpOE__EXT_TEMP_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EXT_TEMP_ADC_net[0:0]}),
		  .analog({Net_81}),
		  .io({tmpIO_0__EXT_TEMP_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__EXT_TEMP_ADC_net),
		  .interrupt({tmpINTERRUPT_0__EXT_TEMP_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EXT_TEMP_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    DieTemp_P4_v1_0_2 DieTemp (
        .temp(Net_82));
